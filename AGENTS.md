...
* `python3 "$ARU_SDLC_HOME/scripts/revert_merge.py" --pr <ID> --agent <AGENT_ID> [--family <family>]` — governed reverse gear: creates a revert PR, reopens affected issues to Ready status, and enforces clean revert checks
