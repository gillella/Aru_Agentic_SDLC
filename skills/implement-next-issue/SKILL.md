...
9. Wait for the exact-head `aru-governed-pr` server check. Tier 0 documentation
   and Tier 1 ordinary code do not wait for authoritative review; Tier 2
   ...
   paths fail upward.
   The server check runs `.aru/verify.sh` and validates the linked issue's
