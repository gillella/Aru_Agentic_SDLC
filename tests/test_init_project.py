...
class ProjectBootstrapTests(unittest.TestCase):
    ...
    def test_generated_governance_uses_coderabbit_and_mechanical_merge(self):
        ...
        self.assertIn("**CodeRabbit is the default PR code-review authority, with an explicit per-pull-request fallback.**", normalized)
        self.assertNotRegex(rules, r"review:codeant")
